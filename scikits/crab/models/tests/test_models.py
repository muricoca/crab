...
def test_basic_methods_DictBooleanPrefDataModel():
    #Empty Dataset
    model = DictBooleanPrefDataModel({})
    assert_equals(model.dataset, {})
    assert_array_equal(np.array([]), model.user_ids())
    assert_array_equal(np.array([]), model.item_ids())
    ...
    #Simple DataSet
    model = DictBooleanPrefDataModel(movies_boolean)
...
def test_preferences_from_user_exists_DictBooleanPrefDataModel():
    model = DictBooleanPrefDataModel(movies_boolean)
    #ordered by item_id
...
def test_preferences_from_user_exists_no_preferences_DictBooleanPrefDataModel():
    model = DictBooleanPrefDataModel(movies_boolean)
    assert_array_equal(np.array([]), model.preferences_from_user('Maria Gabriela'))


def test_preferences_from_user_non_existing_user_DictBooleanPrefDataModel():
    model = DictBooleanPrefDataModel(movies_boolean)
    assert_raises(UserNotFoundError, model.preferences_from_user, 'Flavia')


def test_item_ids_from_user_DictBooleanPrefDataModel():
    model = DictBooleanPrefDataModel(movies_boolean)
    assert_array_equal(np.array(['Just My Luck', 'Lady in the Water', 'Snakes on a Plane',
           'Superman Returns', 'The Night Listener', 'You, Me and Dupree']),
      model.items_from_user('Marcel Caraciolo'))
...
def test_preferences_for_item_existing_item_DictBooleanPrefDataModel():
    model = DictBooleanPrefDataModel(movies_boolean)
    #ordered by item_id
...
def test_preferences_for_item_existing_item_no_preferences_DictBooleanPrefDataModel():
    model = DictBooleanPrefDataModel(movies_boolean)
    assert_array_equal(np.array([]), model.preferences_for_item, 'The Night Listener')


def test_preferences_for_item_non_existing_item_DictBooleanPrefDataModel():
    model = DictBooleanPrefDataModel(movies_boolean)
    assert_raises(ItemNotFoundError, model.preferences_for_item, 'Back to the future')


def test_preference_value_DictBooleanPrefDataModel():
    model = DictBooleanPrefDataModel(movies_boolean)
    assert_equals(1.0, model.preference_value('Marcel Caraciolo', 'Superman Returns'))


def test_preference_value__invalid_DictBooleanPrefDataModel():
    model = DictBooleanPrefDataModel(movies_boolean)
    assert_raises(UserNotFoundError, model.preference_value, 'Flavia', 'Superman Returns')
    assert_raises(ItemNotFoundError, model.preference_value, 'Marcel Caraciolo', 'Back to the future')
...
def test_set_preference_value_DictBooleanPrefDataModel():
    #Add
    model = DictBooleanPrefDataModel(movies_boolean)
...
def test_remove_preference_value_DictBooleanPrefDataModel():
    model = DictBooleanPrefDataModel(movies_boolean)
    model.remove_preference('Maria Gabriela', 'Superman Returns')
