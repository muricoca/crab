...
class testPairwise(TestCase):
    ...
    def test_euclidean_distances(self):
        ...
        X = [[2.5, 3.5, 3.0, 3.5, 2.5, 3.0]]
        Y = [[]]
        self.assertRaises(ValueError,euclidean_distances,X,Y)
    ...
    def test_pearson_correlation(self):
        ...
        X = [[2.5, 3.5, 3.0, 3.5, 2.5, 3.0]]
        Y = [[]]
        self.assertRaises(ValueError,pearson_correlation,X,Y)
    ...
    def test_spearman_distances(self):
        ...
        X = [[('a',2.5),('b', 3.5), ('c',3.0), ('d',3.5), ('e', 2.5),('f', 3.0)]]
        Y = [[]]
        self.assertRaises(ValueError,spearman_coefficient,X,Y)
    ...
    def test_tanimoto_distances(self):
    ...
    def test_loglikehood_distances(self):
    ...
    def test_sorensen_distances(self):
    ...
    def test_manthattan_distances(self):
        ...
        X = [[2.5, 3.5, 3.0, 3.5, 2.5, 3.0]]
        Y = [[]]
        self.assertRaises(ValueError,manhattan_distances,X,Y)
